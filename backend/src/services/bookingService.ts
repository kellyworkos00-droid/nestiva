import {
  findBookingById,
  findBookingsByGuestId,
  findBookingsByHostId,
  findBookingsByListingId,
  checkAvailability,
  createBooking,
  updateBookingStatus,
  confirmBooking as confirmBookingModel,
  rejectBooking as rejectBookingModel,
  cancelBooking as cancelBookingModel,
  checkInBooking as checkInBookingModel,
  checkOutBooking as checkOutBookingModel,
  updatePaymentStatus,
  getListingBookingStats,
  getUpcomingBookings as getUpcomingBookingsModel,
...
): { base: number; cleaning: number; service: number; discount: number; total: number } => {
