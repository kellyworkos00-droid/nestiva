...
router.get(
  '/commission/rate',
  paymentController.getCommissionRate
);

// Calculate commission preview (public)
router.post(
  '/commission/calculate',
  paymentController.calculateCommission
);
...
router.post(
  ...
  paymentController.createCommissionForBooking
);
...
router.get(
  '/host/transactions',
  requireAuthMiddleware,
  paymentController.getHostTransactions
);

// Pay commission (protected)
router.post(
  '/commission/:transactionId/pay',
  requireAuthMiddleware,
  paymentController.payCommission
);
...
router.get(
  '/platform/revenue',
  requireAuthMiddleware,
  paymentController.getPlatformRevenue
);
